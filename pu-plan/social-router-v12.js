...
window.fetch=async(input,init)=>{
  ...
  if(typeof nextInit.body==='string'){
    try{body=JSON.parse(nextInit.body);if(body?.action==='feed'&&!body.mode){body.mode=localStorage.getItem('campus_feed_mode')||'for_you';nextInit.body=JSON.stringify(body)}}catch{}
  }
