const CACHE='nolu-shell-20260911-mesh1';
const ROOT=new URL('./',self.registration.scope).href;
const PATHS=[
  './','./index.html','./manifest.webmanifest','./nolu-icon.svg',
  './main.js','./app.js','./guest-privacy.js','./durable-store.js','./durable-bridge.js','./transport-bridge.js','./resilience.js','./offline-session-rescue.js','./cloud.js','./cloud-replication.js','./provider-config.js','./provider-mesh.js','./auth.js','./social-ui.js','./import.js','./semesters.js','./community.js','./discover.js','./pwa.js','./admin.js','./privacy.js',
