...
function clearResilienceFor(uid=''){
  ...
  // durable-bridge.js listens for this once it is loaded. The guard also keeps
  // this privacy module runnable in the lightweight Node unit-test sandbox.
  if(typeof globalThis.CustomEvent==='function'&&typeof document?.dispatchEvent==='function'){
