...
<section class="view on" id="schedule">
  ...
  <div class="human-week" id="humanWeek"></div>
  <div class="classic-schedule" id="classicSchedule"><div class="table-wrap"><div class="grid" id="grid"></div></div><div class="mobile-week" id="mobileWeek"></div><div class="mobile-list" id="mobile"></div></div>
</section>`}
